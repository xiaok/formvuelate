...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('formvuelate')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue', 'formvuelate'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.FormvuelatePluginLookup = {}, global.Vue, global.formvuelate));
}(this, (function (exports, vue, formvuelate) { 'use strict';
  ...
  var lookupSubSchemas = function lookupSubSchemas(SchemaFormWithPlugins) {
    vue.provide(formvuelate.constants.LOOKUP_PARSE_SUB_SCHEMA_FORMS, {
  ...
  * @returns {Array}
  ...
  exports.lookupSubSchemas = lookupSubSchemas;
