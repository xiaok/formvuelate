/**
  ...
  */
import { getCurrentInstance, inject, computed, provide, markRaw, toRefs, watch, h, unref, resolveDynamicComponent } from 'vue';
...
function VeeValidatePlugin(opts) {
  ...
  function veeValidatePlugin(baseReturns, props) {
    ...
    if (!formContext) {
      ...
      formContext = useForm({
        validationSchema: props.validationSchema ? computed(function () {
    ...
    var formSchemaWithVeeValidate = computed(function () {
...
function withField(el) {
  ...
  var wrappedComponent = markRaw({
    ...
    setup: function setup(props, _ref4) {
      ...
      var _useField = useField(name, validations, {
      ...
      var localComponents = inject(constants.INJECTED_LOCAL_COMPONENTS, {});
      var resolvedComponent = resolveComponent(Comp, localComponents);
      return function renderWithField() {
        return h(resolvedComponent, _objectSpread2(_objectSpread2(_objectSpread2({}, props), attrs), mapProps({
